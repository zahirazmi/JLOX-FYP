...
import fyp.zahir.lox.error.FakeErrorReporter;
import fyp.zahir.lox.grammar.Expression;
import fyp.zahir.lox.grammar.Statement;
import fyp.zahir.lox.interpreter.Environment;
import fyp.zahir.lox.interpreter.Interpreter;
import fyp.zahir.lox.interpreter.PostOrderTraversalInterpreter;
import fyp.zahir.lox.interpreter.RuntimeError;
...
import static fyp.zahir.lox.grammar.ExpressionTestFactory._super;
import static fyp.zahir.lox.grammar.ExpressionTestFactory._this;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.assign;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.binary;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.call;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.get;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.grouping;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.literal;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.logical;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.set;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.unary;
import static fyp.zahir.lox.grammar.ExpressionTestFactory.variable;
import static fyp.zahir.lox.grammar.StatementTestFactory._class;
import static fyp.zahir.lox.grammar.StatementTestFactory._if;
import static fyp.zahir.lox.grammar.StatementTestFactory._return;
import static fyp.zahir.lox.grammar.StatementTestFactory._while;
import static fyp.zahir.lox.grammar.StatementTestFactory.blockStatement;
import static fyp.zahir.lox.grammar.StatementTestFactory.expressionStatement;
import static fyp.zahir.lox.grammar.StatementTestFactory.function;
import static fyp.zahir.lox.grammar.StatementTestFactory.print;
import static fyp.zahir.lox.grammar.StatementTestFactory.variableDeclaration;
import static fyp.zahir.lox.lexer.TokenObjectMother.and;
import static fyp.zahir.lox.lexer.TokenObjectMother.bang;
import static fyp.zahir.lox.lexer.TokenObjectMother.bangEqual;
import static fyp.zahir.lox.lexer.TokenObjectMother.equalEqual;
import static fyp.zahir.lox.lexer.TokenObjectMother.greater;
import static fyp.zahir.lox.lexer.TokenObjectMother.greaterEqual;
import static fyp.zahir.lox.lexer.TokenObjectMother.identifier;
import static fyp.zahir.lox.lexer.TokenObjectMother.less;
import static fyp.zahir.lox.lexer.TokenObjectMother.lessEqual;
import static fyp.zahir.lox.lexer.TokenObjectMother.minus;
import static fyp.zahir.lox.lexer.TokenObjectMother.nil;
import static fyp.zahir.lox.lexer.TokenObjectMother.or;
import static fyp.zahir.lox.lexer.TokenObjectMother.plus;
import static fyp.zahir.lox.lexer.TokenObjectMother.slash;
import static fyp.zahir.lox.lexer.TokenObjectMother.star;

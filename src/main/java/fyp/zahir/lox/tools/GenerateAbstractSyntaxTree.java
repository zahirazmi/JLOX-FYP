...
class GenerateAbstractSyntaxTree {
    ...
    public static void main(String[] args) {
        ...
        defineAbstractSyntaxTree(outputDir, "Statement", Arrays.asList(
                ...
                "Class      : Token name, fyp.zahir.lox.grammar.Expression.Variable superclass, List<Statement.Function> methods",
                "Expression : fyp.zahir.lox.grammar.Expression expression",
                "Function   : Token name, List<Token> parameters, List<Statement> body",
                "If         : fyp.zahir.lox.grammar.Expression condition, Statement thenBranch, Statement elseBranch",
                "Print      : fyp.zahir.lox.grammar.Expression expression",
                "Return     : Token keyword, fyp.zahir.lox.grammar.Expression value",
                "Variable   : Token name, fyp.zahir.lox.grammar.Expression initializer",
                "While      : fyp.zahir.lox.grammar.Expression condition, Statement body"
        ));
    }
    ...
    private static void writeBaseClassHeader(String baseClassName, PrintWriter writer) {
        writer.println("package fyp.zahir.lox.grammar;");
        writer.println("");
        writer.println("import java.util.List;");
        writer.println("import fyp.zahir.lox.lexer.Token;");
        writer.println("");
